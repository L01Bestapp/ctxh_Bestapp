...
export default function StudentProfileSettingsScreen() {
    ...
    // State for form fields (Student Default Data)
    const [email, setEmail] = useState('sarah.taylor@student.hcmut.edu.vn');
    const [fullName, setFullName] = useState('Sarah Taylor');
    const [studentId, setStudentId] = useState('2152000'); // Student Specific Field
    ...
    const [faculty, setFaculty] = useState('Computer Science and Engineering'); // Faculty instead of Department/Type

    // Image Picker State
    const [avatar, setAvatar] = useState(require('../assets/images/student_image.png'));
